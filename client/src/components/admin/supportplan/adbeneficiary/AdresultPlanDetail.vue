...
<template>
    <div class="BfnewPlan">
        ...
        <div class="button-group">
            <button v-if="resultDetail.progress_state === '대기'" class="btn-approve" @click="Approval(resultDetail.result_id)">승인</button>
            <button v-if="resultDetail.progress_state === '대기' && !reasoninsert" class="btn-reject" @click="reasoninsert = true">반려하기</button>
        </div>
