            ...
            <div class="gradient-card">
                <div class="login-card">
                    ...
                    <form @submit.prevent="handleLogin">
                        ...
                        <Button type="submit" label="로그인 실행" class="w-full p-3 text-xl font-bold login-btn" />
                    </form>
                </div>
            </div>
        </div>
...
/* 입력창 포커스 시 테두리 색상도 웜톤으로 변경 (선택 사항) */
...
.login-btn {
    ...
    /* 버튼 모서리 둥글게 (앞서 요청하신 10% 느낌) */
    border-radius: 12px !important;
    transition: all 0.2s ease;
}

/* 마우스를 올렸을 때 색상이 반전되는 효과 (선택사항) */
.login-btn:hover {
    background-color: #ffab91 !important;
