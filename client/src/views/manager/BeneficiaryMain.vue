    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div v-else-if="viewMode === 'resultDetail'" class="editor-container">
                <resultPlanDetail :resultId="selectResultId" :beneId="selectedId" @refresh="reloadList" @cancel="viewMode = 'empty'" @select-sub-plan="handleSelectSubPlan" />
            </div>
            <div v-else-if="viewMode === 'resultTempDetail'" class="editor-container">
                <resultTempDetail :resultId="selectResultId" :beneId="selectedId" @refresh="reloadList" @cancel="viewMode = 'empty'" @select-sub-plan="handleSelectSubPlan" />
            </div>
...
.dashboard-container {
    ...
    width: 100%;
    height: 100vh;
    background-color: #fef9f6; /* 전체는 흰색 바탕 */
    overflow: hidden;
}
